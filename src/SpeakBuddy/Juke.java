...
/*
O código apresentado a seguir foi criado por Brian Lichtenwalter e é utilizado
somente para fins de demonstração neste projeto. No entanto ,uma adaptação de 
suas funções pode vir a ser usada no futuro.
*/
...
public class Juke extends JPanel implements Runnable, LineListener, MetaEventListener, ControlContext {
    ...
    class JukeControls extends JPanel implements ActionListener, ChangeListener {
        ...
        public JukeControls() {
            ...
            startB = addButton("Play", p2, sounds.size() != 0);
            ...
            p4.setBackground(new Color(0,153,204));
    ...
    public class PlaybackMonitor extends JPanel implements Runnable {
        ...
        Font font24 = new Font("Segoe UI Semibold",0, 24);
        Font font28 = new Font("Segoe UI Semibold", 0, 28);
        Font font42 = new Font("Segoe UI Semibold", 0, 42);
        ...
        public void paint(Graphics g) {
            ...
            if (errStr != null) {
                ...
                Font font12 = new Font("Segoe UI Semibold", 0, 12);
    ...
    class JukeTable extends JPanel implements ActionListener {
        ...
        public JukeTable() {
            ...
            Font f12 =new Font("Segoe UI Semibold",0,12);
            String add="Add";
            JPanel p1 = new JPanel();
            JMenuBar menuBar = new JMenuBar();
            int strAdd = getFontMetrics(f12).stringWidth(add);
            menuBar.setBorder(new BevelBorder(BevelBorder.RAISED));
            
            JMenu menu = (JMenu) menuBar.add(new JMenu(add));
            String items[] = { "File or Directory of Files", "URL" };
            int strItm = getFontMetrics(f12).stringWidth(items[0]);
            int strItm2 = getFontMetrics(f12).stringWidth(items[1]);
            ...
            int strRmv = getFontMetrics(f12).stringWidth(remove);
    ...
    class Credits extends Thread {
        ...
        int x;
        Font font16 = new Font("Segoe UI Semibold", 0, 16);
